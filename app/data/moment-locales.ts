...
const EN = {
  ...
  manager: {
    ...
    pollOptionsHelp: "You can edit or remove choices that have never received a vote. Save changes between daily Telegram rounds.",
    ...
    pollOptionsInvalid: "Keep at least two different, non-empty choices.",
    pollOptionsConflict: "These choices have votes or a Telegram round is active. Refresh and try again later.",
...
const KM = {
  ...
  manager: {
    ...
    pollOptionsHelp: "អាចកែ ឬលុបបានតែជម្រើសដែលមិនធ្លាប់ទទួលសំឡេង។ រក្សាទុកការផ្លាស់ប្តូរនៅចន្លោះវគ្គបោះឆ្នោត Telegram ប្រចាំថ្ងៃ។",
    ...
    pollOptionsInvalid: "សូមរក្សាជម្រើសខុសគ្នាយ៉ាងតិចពីរ និងមិនទទេ។",
    pollOptionsConflict: "ជម្រើសទាំងនេះមានសំឡេងឆ្នោត ឬវគ្គ Telegram កំពុងដំណើរការ។ សូមផ្ទុកទំព័រឡើងវិញ ហើយព្យាយាមម្តងទៀតពេលក្រោយ។",
