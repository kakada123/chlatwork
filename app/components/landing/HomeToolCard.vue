  ...
  <div class="group relative h-full">
    ...
    >
      ...
      <span class="min-w-0 flex-1">
        <span class="block text-base font-semibold leading-6 text-slate-950 dark:text-white">
          {{ tool.name }}
        </span>
      </span>
    </NuxtLink>
    ...
    <ToolFavoriteButton
      class="absolute z-10"
      :class="artworkPath ? 'right-2 top-2' : 'right-3 top-3'"
      :tool-key="tool.key"
      :tool-name="tool.name"
    />
  </div>
