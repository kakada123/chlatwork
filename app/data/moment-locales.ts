...
const EN = {
  ...
  creator: {
    ...
    pollOptions: "Choices",
    optionImage: "Upload choice image",
    ...
    errors: {
      ...
      pollOptions: "Add two to fifteen different choices.",
  ...
  experience: {
    ...
    voteNoVotes: "No votes were cast.",
    ...
    confirmVoteChoice: (choice: string) => `Sure you want to vote for “${choice}”?`,
  ...
  manager: {
    ...
    editPollOptions: "Edit choices",
    pollOptionsHelp: "Add up to 15 choices, or edit and remove choices that have never received a vote. Save between daily Telegram rounds. Save a new choice before uploading its image.",
    addPollOption: "Add choice",
    optionImage: "Upload or replace image",
    optionImageError: "The choice image could not be saved. Please try again.",
    pollOptionLabel: (number: number) => `Choice ${number}`,
    removePollOption: (label: string) => `Remove ${label}`,
    savePollOptions: "Save choices",
    savingPollOptions: "Saving…",
    cancelPollOptions: "Cancel",
    pollOptionsInvalid: "Keep 2 to 15 different, non-empty choices.",
    pollOptionsConflict: "Choices changed elsewhere, have votes, or a Telegram round is active. Refresh and try again later.",
    pollOptionsError: "The choices could not be saved. Please try again.",
...
const KM = {
  ...
  creator: {
    ...
    pollOptions: "ជម្រើស",
    optionImage: "បញ្ចូលរូបភាពជម្រើស",
    ...
    errors: {
      ...
      pollOptions: "សូមបញ្ចូលជម្រើសខុសគ្នាពី ២ ដល់ ១៥។",
  ...
  experience: {
    ...
    voteNoVotes: "មិនមានអ្នកបោះឆ្នោតទេ។",
    ...
    confirmVoteTitle: "បញ្ជាក់ការបោះឆ្នោត",
    confirmVoteChoice: (choice: string) => `ប្រាកដថាចង់បោះឆ្នោតឱ្យ “${choice}” មែនទេ?`,
    confirmVote: "បាទ/ចាស បោះឆ្នោត",
    cancelVote: "បោះបង់",
  ...
  manager: {
    ...
    editPollOptions: "កែសម្រួលជម្រើស",
    pollOptionsHelp: "អាចបន្ថែមជម្រើសរហូតដល់ ១៥ ឬកែ និងលុបជម្រើសដែលមិនធ្លាប់ទទួលសំឡេង។ រក្សាទុកនៅចន្លោះវគ្គបោះឆ្នោត Telegram ប្រចាំថ្ងៃ។ សូមរក្សាទុកជម្រើសថ្មី មុនបញ្ចូលរូបភាព។",
    addPollOption: "បន្ថែមជម្រើស",
    optionImage: "បញ្ចូល ឬប្ដូររូបភាព",
    optionImageError: "មិនអាចរក្សាទុករូបភាពជម្រើសបានទេ។ សូមព្យាយាមម្តងទៀត។",
    pollOptionLabel: (number: number) => `ជម្រើសទី ${number}`,
    removePollOption: (label: string) => `លុប ${label}`,
    savePollOptions: "រក្សាទុកជម្រើស",
    savingPollOptions: "កំពុងរក្សាទុក…",
    cancelPollOptions: "បោះបង់",
    pollOptionsInvalid: "សូមរក្សាជម្រើសខុសគ្នា និងមិនទទេពី ២ ដល់ ១៥។",
    pollOptionsConflict: "ជម្រើសត្រូវបានកែប្រែនៅកន្លែងផ្សេង មានសំឡេងឆ្នោត ឬវគ្គ Telegram កំពុងដំណើរការ។ សូមផ្ទុកទំព័រឡើងវិញ ហើយព្យាយាមម្តងទៀតពេលក្រោយ។",
    pollOptionsError: "មិនអាចរក្សាទុកជម្រើសបានទេ។ សូមព្យាយាមម្តងទៀត។",
    historySummary: (days: number, votes: number) =>
