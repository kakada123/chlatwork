...
const COPY: Record<AppLocale, LandingCopy> = {
  ...
  km: {
    ...
    toolsPage: {
      ...
      metaDescription:
        "ស្វែងរកឧបករណ៍ និង developer tools ដែលផ្តោតលើភាពឯកជន។",
      eyebrow: "ឧបករណ៍",
      title: "មើលឧបករណ៍",
...
> = {
  ...
  km: {
    ...
    base64: {
      ...
      description: "បម្លែង encode/decode និងបម្លែងឯកសារ Base64 នៅលើម៉ាស៊ីនអ្នក។",
    },
    "json-formatter": {
      name: "រៀបចំ JSON",
...
function getInitialLocale(routePath: string): AppLocale {
  return routePath === "/km" || routePath.startsWith("/km/")
    ? "km"
    : "en";
}
