      ...
      <div class="cutline rounded-[18px] p-4">
        ...
        <div class="space-y-2 text-sm">
          <div class="rowbox">
            ...
            <span class="value">{{ props.ssid || "—" }}</span>
          </div>
          ...
          >
            ...
            <span class="value">{{ props.displayPassword || "—" }}</span>
          </div>
          ...
          >
            Password required — please ask staff.
          </p>
          ...
          >
            សូមកុំចែករំលែកពាក្យសម្ងាត់ជាមួយអ្នកដទៃ 🙏
          </p>
        </div>

        <div class="mt-4 text-center text-[11px] text-gray-400">
          Generated by ChlatWork • chlatwork.com
        </div>
      </div>
    </div>
  </div>
