...
export const CREATOR_TOOLS: CreatorToolDefinition[] = [
  ...
  {
    id: "khmer-grammar",
    title: "Khmer & English Grammar",
    shortTitle: "Grammar",
    description:
      "Correct Khmer or English grammar, keep your original language, and see explanations of mistakes and missing words.",
    category: "khmer",
    route: "/creator/khmer/grammar",
    icon: "grammar",
    inputType: "text",
    inputLabel: "Khmer or English text",
    inputPlaceholder: "Paste Khmer or English text to correct…",
    config: [],
    resultKind: "text",
    submitLabel: "Correct Grammar",
    creditCost: { type: "fixed", credits: 1 },
    fast: true,
  },
  {
